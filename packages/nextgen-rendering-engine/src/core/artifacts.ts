...
export function defaultOutputDirectory(job: RenderJob): string {
  return job.outputDirectory ?? "out/nextgen-rendering-engine";
}
...
export function result(
  ...
  return {
    ...
    diagnostics,
    manifest: {
      engine: "@gestaltview/nextgen-rendering-engine",
      backend,
...
export class FileArtifactSink implements ArtifactSink {
  ...
  constructor(private readonly rootDir = "out/nextgen-rendering-engine") {}
