...
import { RejectAgentVersionRequestSchema } from "../../../../shared/agent-trainer/schemas.js";
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const input = RejectAgentVersionRequestSchema.parse(req.body ?? {});
    ...
    sendJson(res, 200, {
      ...
      receipt: {
        code: "run_rejected",
        message: "Review rejected and run marked completed.",
        eventId: null,
    ...
    sendJson(res, 500, { error: error instanceof Error ? error.message : "Failed to reject version." });
  }
}
