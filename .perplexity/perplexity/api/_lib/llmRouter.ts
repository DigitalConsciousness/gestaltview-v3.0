...
//
// LLM provider cascade: Ollama → Groq → HuggingFace → OpenRouter → Gemini → Anthropic → OpenAI
...
function offlineFallback(
  ...
  const response = excerpt
    ? `I hear you. Let's keep weaving this carefully: "${excerpt}"`
    : "I'm here and listening. Drop the thought in your own words and we'll weave it together.";
