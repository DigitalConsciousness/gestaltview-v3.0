...
│   └── voice/billy.ts               # ElevenLabs TTS proxy
├── shared/
...
| Voice output | `/api/voice/billy` proxies ElevenLabs TTS; browser hooks and the optional Python worker coordinate the broader voice experience |
...
| Voice | `ELEVENLABS_API_KEY`, `ELEVENLABS_BILLY_VOICE_ID` | `/api/voice/billy` |
