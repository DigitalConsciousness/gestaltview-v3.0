...
|---|-----------|-----------------|
| U-1 | **Never Look Away** | The system must engage with the full complexity of uncomfortable truths; it is strictly forbidden from deflecting or abandoning the user. |
