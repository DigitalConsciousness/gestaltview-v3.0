...
1. **Orient**
   - Read `README.md`, `COLAB.md`, `docs/CurrentState.md`, `docs/ContinuityStack.md`, `docs/orchestration/execution-spine.md` when orchestration is involved, and the touched runtime docs.
...
1. Update the core runtime docs first:
   ...
   - `docs/AIFlow.md`
   - `docs/APIFlow.md`
   - `docs/orchestration/execution-spine.md`
   - `docs/Manifest.md`
