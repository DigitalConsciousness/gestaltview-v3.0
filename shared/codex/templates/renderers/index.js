...
export function stripEmbellishment(text) {
  let out = text;
...
export function renderParagraphs(value) {
...
export function renderProvenanceDrawer(artifact) {
...
export function renderArtifactSummary(artifact) {
