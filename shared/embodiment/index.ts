...
const TRAINER_PERSONA_CONFIG = {
  ...
  skully: {
    profileSlug: "groq-embodiment-expert",
    role: "Schema Steward and Seeding Agent",
    audience: "a founder who needs their runtime schema mapped, populated, and kept alive with deliberate growth",
  },
} as const;
