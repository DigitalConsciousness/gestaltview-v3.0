...
- `50` top-level skills are in the strict curated manifest.
- `22` of those are the highlighted core for a lean skill-corpus rebuild.
- `122` top-level folders on disk contain `SKILL.md`.
