...
SUPABASE_URL = "https://ltajayfzlaevchxngkrm.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZkcXlrbWVmZ3l1eXR3bnFjdGhnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzAzNTc0ODcsImV4cCI6MjA4NTkzMzQ4N30.TAuYWc7t92ophB1ISypjdb5vT-6BSrOSRKYYnBjvjPo"
CORPUS_DIR = Path("/home/ubuntu/gv_corpus")
CHUNK_SIZE = 600          # target chars per chunk
CHUNK_OVERLAP = 80        # overlap between chunks
BATCH_SIZE = 20           # fragments per Supabase insert batch
...
def main():
    ...
    if not table_exists():
        ...
        print("  Please run the SQL migration first (see scripts/create_knowledge_table.sql)")
        sys.exit(1)
