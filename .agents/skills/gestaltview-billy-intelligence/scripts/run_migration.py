...
SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZkcXlrbWVmZ3l1eXR3bnFjdGhnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MDM1NzQ4NywiZXhwIjoyMDg1OTMzNDg3fQ.tYlSmbYFBM0Q604tFg1_-w87zkQZbWsS7wI_DDrBo-g"

# The SQL statements to execute (split into individual statements)
SQL_STATEMENTS = [
    # 1. Enable pgvector
...
def run_sql(sql: str, description: str) -> bool:
    ...
    resp = requests.post(
        f"https://api.supabase.com/v1/projects/fdqykmefgyuytwnqcthg/database/query",
        headers={
