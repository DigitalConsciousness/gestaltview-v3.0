...
| Book-scale / multi-domain platform (> 500 files or many distinct subsystems) | 15-30 pages, or 25-40 H1 chapters in a single-file export |

For large platform repos, the page count is a floor, not a ceiling. Prefer explicit subsystem coverage over over-compression.
...
- **AI Runtime**: Agent runtime, routing, model/provider orchestration
- **Knowledge & Retrieval**: RAG, ingestion, memory, corpus lifecycle
- **Frontend/UI**: Components, pages, styling
- **Backend/Services**: Server logic, middleware
- **Product Domains**: Exhibits, verticals, feature families
- **Agent & Skills Layer**: Agents, skills, orchestration, manifests
- **Tooling & Health**: Scripts, testing, CLI, diagnostics
- **Testing**: Test strategy, examples
- **Deployment**: Build, deploy, infrastructure
- **Development Guide**: Contributing, code standards
- **Glossary**: Domain-specific terminology and entity crosswalk
