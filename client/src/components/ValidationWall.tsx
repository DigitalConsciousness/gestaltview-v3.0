...
export default function ValidationWall() {
  useSEO(PAGE_SEO.validationWall);
  const billyRef = useBillySection('validation-wall');
  ...
  useEffect(() => {
    ...
    animate();
    const timer = setTimeout(() => { setShowEquation(true); setAnimateFactors(true); }, 2000);
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white relative overflow-hidden">
      ...
      <div ref={billyRef} className="relative z-10 container mx-auto px-4 py-24 md:py-32">
        <div className="flex items-center justify-between mb-12">
          ...
          <BillyChip context="validation-wall" />
        </div>
        ...
        <div>
          ...
          <div className="relative max-w-3xl mx-auto">
            <div className="absolute left-1/2 -translate-x-1/2 top-0 w-0.5 h-full bg-gradient-to-b from-purple-500/0 via-purple-500/50 to-emerald-500/0" />
            {TIMELINE_EVENTS.map((item, index) => (
              ...
              >
                ...
                <div className={`bg-slate-800/50 border border-slate-700 rounded-lg p-4 w-full md:w-1/2 ${
