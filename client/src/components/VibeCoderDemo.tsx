...
const Header: React.FC = () => {
  ...
  return (
    <header className="relative z-10 p-6 sm:p-8 text-center bg-gradient-to-br from-[#667eea] to-[#764ba2] border-b-2 border-[rgba(102,126,234,0.2)] shadow-[0_4px_30px_rgba(102,126,234,0.3)]">
      <button
        onClick={() => navigate('/')}
        className="absolute left-4 top-4 text-white/75 hover:text-white text-sm flex items-center gap-1 transition-colors"
      >
        ← Home
      </button>
      <div className="flex items-center justify-center gap-3 mb-2">
        <Code2 className="w-8 h-8 sm:w-9 sm:h-9 text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]" />
        <h1 className="text-3xl sm:text-4xl font-semibold bg-clip-text text-transparent bg-gradient-to-br from-white to-[#f093fb] tracking-tight">
          VibeCoder<span className="text-[#f093fb] font-medium text-shadow-[0_0_20px_#f093fb]">&lt;/&gt;</span>
        </h1>
      </div>
