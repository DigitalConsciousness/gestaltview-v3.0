...
import { 
  ...
  Star, Clock, Award, TreePine, type LucideIcon 
} from 'lucide-react';
...
const ConsciousnessCompanionChat = ({ 
  ...
  const processMessage = useCallback(async (userMessage: string) => {
    ...
    return response;
  }, [userName, preferredName, personality, callConsciousnessAPI, messages, onMemoryCapture, embodimentProfileSlug]);
      ...
      <div className="p-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-t-xl">
        ...
        <div className="mt-4">
          <EmbodimentSelector
            ...
            triggerClassName="border-white/15 bg-white/10 text-white"
