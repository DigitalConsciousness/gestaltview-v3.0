-- Deferred from 20260420150000_human_continuity_schema.sql because this
-- post-state repair depends on tables created in the June 2026 migrations.
...
begin
  if exists (
    ...
    where namespace.nspname = 'public'
      and relation.relname = 'human_memory_records'
    ...
    raise notice 'Skipping human_memory_records_embedding_idx: embedding is not vector(768)';
  end if;
end
$$;
