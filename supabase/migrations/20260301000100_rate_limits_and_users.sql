...
DROP POLICY IF EXISTS "Service role full access on session_rate_limits" ON session_rate_limits;
...
DROP TRIGGER IF EXISTS session_rate_limits_updated_at ON session_rate_limits;
